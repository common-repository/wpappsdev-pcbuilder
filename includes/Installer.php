...
class Installer {
	 ...
	 * @return void
	 */
	public function create_configuration_table() {
		global $wpdb;
		...
		$alter_sql = "ALTER TABLE `{$wpdb->prefix}wpadpcbu_saved_pc` ADD `share_key` text NULL AFTER `configurations`";
		maybe_add_column( "{$wpdb->prefix}wpadpcbu_saved_pc", 'share_key', $alter_sql );
