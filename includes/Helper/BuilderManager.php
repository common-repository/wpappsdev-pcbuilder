	...
	public function builder_actions() {
		$actions = [
			'wpadpcbu-product-cart' => [
				'name'       => __( 'Add To Cart', 'wpappsdev-pcbuilder' ),
				'href'       => '#',
				'icon-class' => 'dashicons dashicons-cart',
			],
			'wpadpcbu-save' => [
				'name'       => __( 'Saved Build', 'wpappsdev-pcbuilder' ),
				'href'       => '#',
				'icon-class' => 'dashicons dashicons-vault',
				'title'      => __( 'Saved Build Data', 'wpappsdev-pcbuilder' ),
			],
			'wpadpcbu-screenshots' => [
				'name'       => __( 'Screenshot', 'wpappsdev-pcbuilder' ),
				'href'       => '#',
				'icon-class' => 'dashicons dashicons-camera',
			],
			'wpadpcbu-hidden-component' => [
				'name'       => __( 'Hide Un-configured', 'wpappsdev-pcbuilder' ),
				'href'       => '#',
				'icon-class' => 'dashicons dashicons-hidden',
				'title' => __( 'Hide Un-configured Components', 'wpappsdev-pcbuilder' )
			],
			'wpadpcbu-show-component' => [
				'name'       => __( 'Show Un-configured', 'wpappsdev-pcbuilder' ),
				'href'       => '#',
				'icon-class' => 'dashicons dashicons-visibility',
				'title' => __( 'Show Un-configured Components', 'wpappsdev-pcbuilder' )
			],
		];
